...
console.log("----> server.disOptions \n" + JSON.stringify(server.disOptions));
server.discovery().then(discovery => {
    console.log("----> Server discovery \n" + JSON.stringify(discovery));
console.log("----> 1 server.disOptions \n" + JSON.stringify(server.disOptions));
...
//console.log("----> 2 --> server.disOptions \n" + JSON.stringify(server.disOptions));
//server.discovery().then(discovery => {
//    console.log("----> 2 Server discovery \n" + JSON.stringify(discovery));
//console.log("----> 2 server.disOptions \n" + JSON.stringify(server.disOptions));
//    console.log("----> 2 Server discovery.title \n" + discovery.title);
//
//});
