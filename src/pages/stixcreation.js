...
export class Stix extends Component {

  constructor(props) {
    super(props);
    this.state = { discovery: undefined, selectedValue: 0, spacing: '12' };
  ...
  componentDidMount() {
    this.server.discovery().then(discovery => {
      ...
      <div className={this.props.root}>
        <Grid container spacing={8}>
          ...
          <Grid item xs={12} sm={6}>
            <Typography type="body1" wrap>something here</Typography>
            {this.serverInfo()}
          </Grid>
...
export default withRoot(withStyles(styles)(Stix));